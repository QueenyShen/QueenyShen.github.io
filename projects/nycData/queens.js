...
function changeBackground() {
	...
	if (
		...
		hovering9 = false;
		hovering10 = false;
		backgroundColor8 = "rgb(137, 178, 200 )";
	} else {
		hovering8 = false;
	...
	if (
		...
		hovering9 = true;
		hovering10 = false;
		backgroundColor9 = "rgb(133, 183, 211)";
	} else {
		hovering9 = false;
	...
	if (
		...
		hovering9 = false;
		hovering10 = true;
		backgroundColor10 = "rgb(134, 188, 219)";
	  } else {
		hovering10 = false;
